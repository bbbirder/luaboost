--author:bbbirder
--@Dependencies: raknet framework
BitStream = {}
	function BitStream:create(packet)
		if packet then
			return mine.BitStreamHelper:createWithData(packet:getData(),packet:getLength(),false)
		end
		return mine.BitStreamHelper:create()
	end
	BitStream.writeBool = mine.BitStreamHelper.writeBool
	BitStream.writeChar = mine.BitStreamHelper.writeChar
	BitStream.writeInt = mine.BitStreamHelper.writeInt
	BitStream.writeFloat = mine.BitStreamHelper.writeFloat
	BitStream.writeLongLong = mine.BitStreamHelper.writeLongLong
	BitStream.writeString = mine.BitStreamHelper.writeString
	BitStream.writeWString = mine.BitStreamHelper.writeWString

	BitStream.readBool = mine.BitStreamHelper.readBool
	BitStream.readChar = mine.BitStreamHelper.readChar
	BitStream.readInt = mine.BitStreamHelper.readInt
	BitStream.readFloat = mine.BitStreamHelper.readFloat
	BitStream.readLongLong = mine.BitStreamHelper.readLongLong
	BitStream.readString = mine.BitStreamHelper.readString
	BitStream.readWString = mine.BitStreamHelper.readWString

	BitStream.ignoreBytes = mine.BitStreamHelper.ignoreBytes

Net = {}
	local __net = mine.NetHelper:getInstance()
	function Net:send(stream)
		return __net:getPeer():send(stream,__net:getServerAddress())
	end
	-- TODO:Bug
	Net.getNewPacket = mine.BitStreamHelper.getNewPacket
...
local constants =  {
    ...
    "ID_REGISTER",
    "ID_LOGIN",--138
    "ID_LOGIN_FROM_CLIENT",
    "ID_LOGIN_TO_GAME",--140
    "ID_LOG_OUT",
    "ID_BEGIN_ROUND",
    "ID_DISCARD",
    "ID_CAN_WIN",
    ...
    "ID_LAST_TILE",
    "ID_REPLY_LAST_TILE",
    "ID_CAN_DEAL_FROM_KONG",--170
    "ID_WIN_AT_KONGING",
    "ID_KONG_AT_KONGING",
    "ID_PONG_AT_KONGING",
    "ID_EAT_AT_KONGING",
    "ID_PASS_AT_KONGING",
    "ID_CAN_DEAL_FROM_LAST_TILE",
    "ID_DEAL_FROM_LAST_TILE",
    "ID_GET_PLAYER_IP",
    "ID_NEW_CAN_KONG",
    "ID_NEW_KONG",--180
    "ID_NEW_KONG_AT_KONGING",
    "ID_PAY_NEW_ORDER",
    "ID_DONE_PAY",
    "ID_GET_MOHJONG_LOG",
    "ID_SAME_IP_WARNING",
